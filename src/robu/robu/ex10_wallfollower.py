...
ROBOT_DIRECTION_LEFT_INDEX = 225
...
class WallFollower(rclpy.Node):
    def __init__(self):     #__ beutete dass es private ist, ist der Konstruktor
        super().__init__('WallFollowe')
        ...
        self.left_dist = 999999.9 # Initialisiere den Variable auf einen ungueltigen Wert
